...
class Family
{
     ...
     * Set leader
     *
     * @param \TheCommons\CommonFolkBundle\Entity\Person $leader
     * @return Family
     */
    public function setLeader(\TheCommons\CommonFolkBundle\Entity\Person $leader = null)
    {
        $this->leader = $leader;
     ...
     * @return Family
     */
    public function addPeople(\TheCommons\CommonFolkBundle\Entity\Person $people)
    {
        $this->people[] = $people;
     ...
     * @param \TheCommons\CommonFolkBundle\Entity\Person $people
     */
    public function removePeople(\TheCommons\CommonFolkBundle\Entity\Person $people)
    {
