...
$('#thecommons_commonfolk_person_roles').select2();

var firstRun = true;

// update mentor list based on current dstage
$('#thecommons_commonfolk_person_discipleshipStage').change( function() {

    var pm = d3.select('#thecommons_commonfolk_person_mentor');
